    ...
    public void onClick(View view) {
        if(view.getId()==R.id.layout_option_uno){
            ...
            if (linearLayoutDetails.getVisibility() == View.GONE) {
                CategoriasActivityExpandAndCollapseViewUtil.expand(linearLayoutDetails, DURATION);
                imageViewExpand.setImageResource(R.drawable.flecha_abajo_categorias);
                rotate(-180.0f,imageViewExpand);
            } else {
                CategoriasActivityExpandAndCollapseViewUtil.collapse(linearLayoutDetails, DURATION);
                imageViewExpand.setImageResource(R.drawable.flecha_abajo_categorias);
            ...
            if (linearLayoutDetails1.getVisibility() == View.GONE) {
                CategoriasActivityExpandAndCollapseViewUtil.expand(linearLayoutDetails1, DURATION);
                imageViewExpand1.setImageResource(R.drawable.flecha_abajo_categorias);
                rotate(-180.0f,imageViewExpand1);
            } else {
                CategoriasActivityExpandAndCollapseViewUtil.collapse(linearLayoutDetails1, DURATION);
                imageViewExpand1.setImageResource(R.drawable.flecha_abajo_categorias);
            ...
            if (linearLayoutDetails2.getVisibility() == View.GONE) {
                CategoriasActivityExpandAndCollapseViewUtil.expand(linearLayoutDetails2, DURATION);
                imageViewExpand2.setImageResource(R.drawable.flecha_abajo_categorias);
                rotate(-180.0f,imageViewExpand2);
            } else {
                CategoriasActivityExpandAndCollapseViewUtil.collapse(linearLayoutDetails2, DURATION);
                imageViewExpand2.setImageResource(R.drawable.flecha_abajo_categorias);
